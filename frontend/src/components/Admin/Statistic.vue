<template>
    <div class="board-container">
      <h2 class="title">Data visualizaiton</h2>
  ...
  function updateChartData() {
    const { registered_users, listed_staterooms, total_bookings, total_trips } = dashboardData.value
    chartData.value = {
      labels: ['Registered Users', 'Listed Staterooms', 'Total Bookings', 'Total Trips'],
      datasets: [
        {
          label: 'Count',
          data: [registered_users, listed_staterooms, total_bookings, total_trips],
